...
int	main(void)
{
    ...
    std::cout << "I am " << D1.getName() << " and my hit points as a DiamondTrap are " << D1.getHP() << std::endl;
    std::cout << "I am " << D1.getName() << " and my energy points as a DiamondTrap are " << D1.getEnergy() << std::endl;
